<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://internal-apptier-lb-992887380.eu-north-1.elb.amazonaws.com/login_page/login_backend.php");
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($_POST)); // Forward POST data
